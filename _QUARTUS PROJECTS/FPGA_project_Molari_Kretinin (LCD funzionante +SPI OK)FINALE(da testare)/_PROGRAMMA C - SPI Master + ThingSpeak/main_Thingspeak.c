...
int main(int argc, char *argv[]) {
   ...
   // CURLcode res;
    ...
    while(1){
        ...
        received = SPIM_WriteReadTxRxData16(0xF22F); // Comunicazione con l'SPI, invio "F22F" e risposta su "temp"
...
/*¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤Lettura da thingspeak¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤*/
    ...
    /*
    char url[] = "https://api.thingspeak.com/channels/2827121/fields/1/last.txt?api_key=0088RSBXYPCI5POU";
