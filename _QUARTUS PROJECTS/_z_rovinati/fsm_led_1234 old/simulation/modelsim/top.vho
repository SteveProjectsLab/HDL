...
-- PCB_DB[0]	=>  Location: PIN_D8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PCB_DB[1]	=>  Location: PIN_AG18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PCB_DB[2]	=>  Location: PIN_W11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PCB_DB[3]	=>  Location: PIN_AG26,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PCB_DB[4]	=>  Location: PIN_AA26,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PCB_DB[5]	=>  Location: PIN_V13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PCB_DB[6]	=>  Location: PIN_AA15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- PCB_DB[7]	=>  Location: PIN_AE7,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \delay[0]~DUPLICATE_q\ : std_logic;
...
SIGNAL \delay[3]~DUPLICATE_q\ : std_logic;
...
SIGNAL \delay[16]~DUPLICATE_q\ : std_logic;
...
SIGNAL \w_led2~feeder_combout\ : std_logic;
...
SIGNAL \ALT_INV_delay[3]~DUPLICATE_q\ : std_logic;
SIGNAL \ALT_INV_delay[2]~DUPLICATE_q\ : std_logic;
SIGNAL \ALT_INV_delay[0]~DUPLICATE_q\ : std_logic;
...
SIGNAL \ALT_INV_delay[16]~DUPLICATE_q\ : std_logic;
...
\ALT_INV_delay[3]~DUPLICATE_q\ <= NOT \delay[3]~DUPLICATE_q\;
\ALT_INV_delay[2]~DUPLICATE_q\ <= NOT \delay[2]~DUPLICATE_q\;
\ALT_INV_delay[0]~DUPLICATE_q\ <= NOT \delay[0]~DUPLICATE_q\;
...
\ALT_INV_delay[16]~DUPLICATE_q\ <= NOT \delay[16]~DUPLICATE_q\;
...
-- Equation(s):
-- \Add0~77_sumout\ = SUM(( \delay[0]~DUPLICATE_q\ ) + ( VCC ) + ( !VCC ))
-- \Add0~78\ = CARRY(( \delay[0]~DUPLICATE_q\ ) + ( VCC ) + ( !VCC ))
...
-- pragma translate_on
PORT MAP (
	datad => \ALT_INV_delay[0]~DUPLICATE_q\,
	cin => GND,
	sumout => \Add0~77_sumout\,
	cout => \Add0~78\);

-- Location: FF_X88_Y2_N2
\delay[0]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \Add0~89_sumout\ = SUM(( \delay[3]~DUPLICATE_q\ ) + ( VCC ) + ( \Add0~86\ ))
-- \Add0~90\ = CARRY(( \delay[3]~DUPLICATE_q\ ) + ( VCC ) + ( \Add0~86\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \ALT_INV_delay[3]~DUPLICATE_q\,
	cin => \Add0~86\,
	sumout => \Add0~89_sumout\,
	cout => \Add0~90\);

-- Location: FF_X88_Y2_N11
\delay[3]~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \Equal0~2_combout\ = ( !delay(20) & ( !\delay[19]~DUPLICATE_q\ & ( (!delay(21) & (!delay(23) & (!delay(22) & !delay(25)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => ALT_INV_delay(21),
	datab => ALT_INV_delay(23),
	datac => ALT_INV_delay(22),
	datad => ALT_INV_delay(25),
	datae => ALT_INV_delay(20),
	dataf => \ALT_INV_delay[19]~DUPLICATE_q\,
...
-- Equation(s):
-- \Equal0~0_combout\ = ( !delay(7) & ( !delay(9) & ( (!delay(29) & (!delay(30) & (!delay(8) & !delay(28)))) ) ) )
...
-- Equation(s):
-- \Equal0~4_combout\ = ( !delay(12) & ( !delay(13) & ( (!delay(17) & (!delay(6) & (!delay(15) & !delay(14)))) ) ) )
...
PORT MAP (
	...
	datab => ALT_INV_delay(6),
	datac => ALT_INV_delay(15),
	datad => ALT_INV_delay(14),
	datae => ALT_INV_delay(12),
	dataf => ALT_INV_delay(13),
	combout => \Equal0~4_combout\);

-- Location: FF_X88_Y2_N8
\delay[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \Equal0~3_combout\ = ( !delay(5) & ( !delay(3) & ( (!delay(2) & (!delay(4) & (!delay(1) & !delay(0)))) ) ) )
...
-- Equation(s):
-- \Equal0~6_combout\ = ( \Equal0~3_combout\ & ( \Equal0~1_combout\ & ( (\Equal0~2_combout\ & (\Equal0~0_combout\ & (!\delay[10]~DUPLICATE_q\ & \Equal0~4_combout\))) ) ) )
...
PORT MAP (
	...
	datac => \ALT_INV_delay[10]~DUPLICATE_q\,
...
-- Equation(s):
-- \Add0~13_sumout\ = SUM(( delay(9) ) + ( VCC ) + ( \Add0~22\ ))
-- \Add0~14\ = CARRY(( delay(9) ) + ( VCC ) + ( \Add0~22\ ))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \delay[16]~DUPLICATE_q\);

-- Location: LABCELL_X88_Y1_N48
\Equal0~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal0~1_combout\ = ( !\delay[16]~DUPLICATE_q\ & ( !delay(26) & ( (!delay(18) & (!delay(24) & (!delay(27) & !delay(11)))) ) ) )
...
PORT MAP (
	...
	datae => \ALT_INV_delay[16]~DUPLICATE_q\,
	dataf => ALT_INV_delay(26),
	combout => \Equal0~1_combout\);

-- Location: MLABCELL_X87_Y2_N24
\Equal0~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \Equal0~5_combout\ = ( \Equal0~3_combout\ & ( \Equal0~2_combout\ & ( \Equal0~4_combout\ ) ) )
...
-- Equation(s):
-- \Selector1~0_combout\ = ( \state.s1~q\ & ( \delay[10]~DUPLICATE_q\ & ( \state.s0~q\ ) ) ) # ( \state.s1~q\ & ( !\delay[10]~DUPLICATE_q\ & ( !\state.s0~q\ $ (((!\Equal0~1_combout\) # ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))) ) ) ) # ( !\state.s1~q\ 
-- & ( !\delay[10]~DUPLICATE_q\ & ( (\Equal0~1_combout\ & (\Equal0~0_combout\ & (\Equal0~5_combout\ & !\state.s0~q\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000100000000000000011111111000000000000000000000000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \Selector2~0_combout\ = ( \state.s2~q\ & ( \delay[10]~DUPLICATE_q\ & ( !\state.s1~q\ ) ) ) # ( \state.s2~q\ & ( !\delay[10]~DUPLICATE_q\ & ( !\state.s1~q\ $ (((\Equal0~5_combout\ & (\Equal0~1_combout\ & \Equal0~0_combout\)))) ) ) ) # ( !\state.s2~q\ & ( 
-- !\delay[10]~DUPLICATE_q\ & ( (\Equal0~5_combout\ & (\Equal0~1_combout\ & (\state.s1~q\ & \Equal0~0_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000001111100001110000100000000000000001111000011110000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \Selector3~0_combout\ = ( \state.s3~q\ & ( \state.s2~q\ & ( (\Equal0~5_combout\ & (\Equal0~0_combout\ & (\Equal0~1_combout\ & !\delay[10]~DUPLICATE_q\))) ) ) ) # ( !\state.s3~q\ & ( \state.s2~q\ & ( (\Equal0~5_combout\ & (\Equal0~0_combout\ & 
-- (\Equal0~1_combout\ & !\delay[10]~DUPLICATE_q\))) ) ) ) # ( \state.s3~q\ & ( !\state.s2~q\ & ( (!\Equal0~5_combout\) # ((!\Equal0~0_combout\) # ((!\Equal0~1_combout\) # (\delay[10]~DUPLICATE_q\))) ) ) )
...
-- Equation(s):
-- \Selector0~0_combout\ = ( \state.s0~q\ & ( \delay[10]~DUPLICATE_q\ ) ) # ( !\state.s0~q\ & ( \delay[10]~DUPLICATE_q\ & ( \state.s3~q\ ) ) ) # ( \state.s0~q\ & ( !\delay[10]~DUPLICATE_q\ & ( (!\Equal0~1_combout\) # ((!\Equal0~0_combout\) # 
-- ((!\Equal0~5_combout\) # (!\state.s3~q\))) ) ) ) # ( !\state.s0~q\ & ( !\delay[10]~DUPLICATE_q\ & ( !\state.s3~q\ $ (((!\Equal0~1_combout\) # ((!\Equal0~0_combout\) # (!\Equal0~5_combout\)))) ) ) )
...
\w_led2~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \w_led2~feeder_combout\ = ( \state.s2~q\ )
...
PORT MAP (
	dataf => \ALT_INV_state.s2~q\,
	combout => \w_led2~feeder_combout\);

-- Location: FF_X87_Y2_N10
w_led2 : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
PORT MAP (
	clk => \FPGA_CLK1_50~inputCLKENA0_outclk\,
	d => \w_led2~feeder_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \w_led2~q\);

-- Location: FF_X87_Y2_N37
w_led3 : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
