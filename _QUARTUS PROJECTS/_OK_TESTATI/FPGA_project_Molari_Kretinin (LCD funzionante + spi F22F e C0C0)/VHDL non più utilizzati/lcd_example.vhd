...
signal reset_n : std_logic := '0';	-- modifica del 22/11/2024

BEGIN
clk <= not clk after clock_period/2;

-- Ciclo di reset 			-- modifica del 22/11/2024
process					-- modifica del 22/11/2024
begin					-- modifica del 22/11/2024
  reset_n <= '0';			-- modifica del 22/11/2024
  wait for 200 us; -- tempo di reset	-- modifica del 22/11/2024
  reset_n <= '1';			-- modifica del 22/11/2024
  wait;					-- modifica del 22/11/2024
end process;
  ...
  BEGIN
    IF(clk'EVENT AND clk = '1') THEN
      IF(lcd_busy = '0' AND lcd_enable = '0') THEN
        ...
        END IF;
        CASE char IS
          WHEN 1 => lcd_bus <= "1000110001";	-- prima cifra: 1 = dato, 0 = istruzione; seconda cifra: 1 = leggi, 0 = scrivi
