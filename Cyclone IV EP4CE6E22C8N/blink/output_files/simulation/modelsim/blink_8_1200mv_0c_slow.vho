...
-- LED[0]	=>  Location: PIN_73,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LED[1]	=>  Location: PIN_3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LED[2]	=>  Location: PIN_2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LED[3]	=>  Location: PIN_1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \tim_1Hz|Equal0~5_combout\ = (\tim_1Hz|counter\(18) & (\tim_1Hz|counter\(19) & (\tim_1Hz|counter\(16) & !\tim_1Hz|counter\(17))))
...
-- Equation(s):
-- \tim_1Hz|Equal0~1_combout\ = (!\tim_1Hz|counter\(2) & (!\tim_1Hz|counter\(1) & (!\tim_1Hz|counter\(0) & !\tim_1Hz|counter\(3))))
...
-- Equation(s):
-- \tim_1Hz|Equal0~3_combout\ = (\tim_1Hz|counter\(12) & (!\tim_1Hz|counter\(15) & (\tim_1Hz|counter\(14) & \tim_1Hz|counter\(13))))
...
-- Equation(s):
-- \tim_1Hz|Equal0~0_combout\ = (!\tim_1Hz|counter\(4) & (\tim_1Hz|counter\(6) & (!\tim_1Hz|counter\(7) & !\tim_1Hz|counter\(5))))
...
-- Equation(s):
-- \tim_1Hz|Equal0~8_combout\ = (\tim_1Hz|Equal0~6_combout\ & (\tim_1Hz|Equal0~7_combout\ & (\tim_1Hz|Equal0~5_combout\ & \tim_1Hz|Equal0~4_combout\)))
