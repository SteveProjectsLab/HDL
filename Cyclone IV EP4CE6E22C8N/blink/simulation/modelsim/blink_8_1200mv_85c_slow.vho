...
-- LED[1]	=>  Location: PIN_31,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LED[2]	=>  Location: PIN_32,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \tim_1Hz|counter~3_combout\ = (!\tim_1Hz|Equal0~8_combout\ & \tim_1Hz|Add0~24_combout\)
...
-- Equation(s):
-- \tim_1Hz|counter~4_combout\ = (!\tim_1Hz|Equal0~8_combout\ & \tim_1Hz|Add0~26_combout\)
...
-- Equation(s):
-- \tim_1Hz|Equal0~6_combout\ = (\tim_1Hz|counter\(22) & (!\tim_1Hz|counter\(23) & (\tim_1Hz|counter\(21) & \tim_1Hz|counter\(20))))
...
-- Equation(s):
-- \tim_1Hz|Equal0~0_combout\ = (!\tim_1Hz|counter\(7) & (\tim_1Hz|counter\(6) & (!\tim_1Hz|counter\(4) & !\tim_1Hz|counter\(5))))
...
-- Equation(s):
-- \tim_1Hz|Equal0~3_combout\ = (\tim_1Hz|counter\(13) & (\tim_1Hz|counter\(12) & (\tim_1Hz|counter\(14) & !\tim_1Hz|counter\(15))))
...
-- Equation(s):
-- \tim_1Hz|Equal0~4_combout\ = (\tim_1Hz|Equal0~0_combout\ & (\tim_1Hz|Equal0~3_combout\ & (\tim_1Hz|Equal0~2_combout\ & \tim_1Hz|Equal0~1_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \tim_1Hz|Equal0~0_combout\,
	datab => \tim_1Hz|Equal0~3_combout\,
	datac => \tim_1Hz|Equal0~2_combout\,
	datad => \tim_1Hz|Equal0~1_combout\,
...
-- Equation(s):
-- \tim_1Hz|clock_signal~0_combout\ = \tim_1Hz|Equal0~8_combout\ $ (\tim_1Hz|clock_signal~q\)
