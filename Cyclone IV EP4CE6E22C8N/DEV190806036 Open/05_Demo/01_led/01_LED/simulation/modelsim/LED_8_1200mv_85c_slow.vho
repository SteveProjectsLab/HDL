...
-- led[1]	=>  Location: PIN_104,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- led[2]	=>  Location: PIN_105,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- led[3]	=>  Location: PIN_106,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \led~0_combout\ = (\led[0]~reg0_q\) # ((!\led[2]~reg0_q\ & (!\led[3]~reg0_q\ & !\led[1]~reg0_q\)))
...
-- Equation(s):
-- \counter~3_combout\ = (\Add0~24_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \counter~5_combout\ = (\Add0~28_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \counter~10_combout\ = (\Add0~40_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \Equal0~6_combout\ = (counter(22) & (counter(21) & (counter(20) & !counter(23))))
...
-- Equation(s):
-- \Equal1~0_combout\ = (!\led[2]~reg0_q\ & (!\led[3]~reg0_q\ & (!\led[0]~reg0_q\ & !\led[1]~reg0_q\)))
