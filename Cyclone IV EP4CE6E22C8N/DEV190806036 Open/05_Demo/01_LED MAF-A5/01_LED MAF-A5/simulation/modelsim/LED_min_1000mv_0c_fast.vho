...
-- led[0]	=>  Location: PIN_32,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- led[1]	=>  Location: PIN_31,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- led[2]	=>  Location: PIN_30,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \led~1_combout\ = (\led[1]~reg0_q\) # ((!\led[3]~reg0_q\ & (!\led[2]~reg0_q\ & !\led[0]~reg0_q\)))
...
-- Equation(s):
-- \counter~1_combout\ = (!\Equal0~7_combout\ & \Add0~12_combout\)
...
-- Equation(s):
-- \counter~2_combout\ = (!\Equal0~7_combout\ & \Add0~22_combout\)
...
-- Equation(s):
-- \Equal0~6_combout\ = (counter(20) & (!counter(23) & (counter(22) & counter(21))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (counter(13) & (counter(12) & (counter(14) & !counter(15))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!counter(9) & (!counter(10) & (counter(11) & !counter(8))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!counter(3) & (!counter(1) & (!counter(2) & !counter(0))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (counter(24) & (\Equal0~6_combout\ & (\Equal0~5_combout\ & \Equal0~4_combout\)))
...
-- Equation(s):
-- \led~0_combout\ = (\led[0]~reg0_q\) # ((!\led[3]~reg0_q\ & (!\led[1]~reg0_q\ & !\led[2]~reg0_q\)))
...
-- Equation(s):
-- \Equal1~0_combout\ = (!\led[1]~reg0_q\ & (!\led[3]~reg0_q\ & (!\led[0]~reg0_q\ & !\led[2]~reg0_q\)))
