...
-- led[3]	=>  Location: PIN_112,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \counter~8_combout\ = (\Add0~38_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \counter~12_combout\ = (\Add0~44_combout\ & !\Equal0~7_combout\)
...
-- Equation(s):
-- \Equal0~6_combout\ = (counter(20) & (counter(21) & (counter(22) & !counter(23))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!counter(0) & (!counter(3) & (!counter(2) & !counter(1))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!counter(9) & (counter(11) & (!counter(8) & !counter(10))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (\Equal0~5_combout\ & (counter(24) & (\Equal0~6_combout\ & \Equal0~4_combout\)))
