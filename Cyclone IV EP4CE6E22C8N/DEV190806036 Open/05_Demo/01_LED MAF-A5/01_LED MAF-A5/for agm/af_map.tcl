...
set verilogs { F:\\PCB PRO\\FPGA Core board\\MCC-C\\MCC-C-V1R06\\MCC-C-CX-V1R06\\01_LED MAF-A5\\LED.v }
if { [ llength $verilogs ] == 0 } {
  set verilogs "F:/PCB PRO/FPGA Core board/MCC-C/MCC-C-V1R06/MCC-C-CX-V1R06/01_LED MAF-A5/${DESIGN}.v"
}
